...
define.test({
  ...
  include: [
    ...
    './tests/eslint/rules/id-denylist.test.ts',
    './tests/eslint/rules/id-length.test.ts',
    ...
    './tests/eslint/rules/no-magic-numbers.test.ts',
    ...
    './tests/eslint/rules/operator-assignment.test.ts',
    ...
    './tests/eslint-plugin-node/rules/exports-style.test.ts',
    './tests/eslint-plugin-node/rules/file-extension-in-import.test.ts',
    ...
    './tests/eslint-plugin-node/rules/no-callback-literal.test.ts',
    './tests/eslint-plugin-node/rules/no-deprecated-api.test.ts',
    ...
    './tests/eslint-plugin-node/rules/no-mixed-requires.test.ts',
    ...
    './tests/eslint/rules/consistent-this.test.ts',
    ...
    './tests/eslint-plugin-jest/rules/padding-around-after-all-blocks.test.ts',
    './tests/eslint-plugin-jest/rules/padding-around-after-each-blocks.test.ts',
    './tests/eslint-plugin-jest/rules/padding-around-all.test.ts',
    './tests/eslint-plugin-jest/rules/padding-around-before-all-blocks.test.ts',
    './tests/eslint-plugin-jest/rules/padding-around-before-each-blocks.test.ts',
    './tests/eslint-plugin-jest/rules/padding-around-describe-blocks.test.ts',
    './tests/eslint-plugin-jest/rules/padding-around-expect-groups.test.ts',
    './tests/eslint-plugin-jest/rules/padding-around-test-blocks.test.ts',
    ...
    './tests/rstest/rules/no-restricted-matchers.test.ts',
    ...
    './tests/rstest/rules/padding-around-before-all-blocks.test.ts',
    './tests/rstest/rules/padding-around-before-each-blocks.test.ts',
    './tests/rstest/rules/padding-around-describe-blocks.test.ts',
    './tests/rstest/rules/padding-around-expect-groups.test.ts',
    './tests/rstest/rules/padding-around-test-blocks.test.ts',
